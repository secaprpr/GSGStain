...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--netD', type=str, default='basic', choices=['basic', 'n_layers', 'pixel', 'patch', 'dualbranch', 'tilestylegan2', 'stylegan2'], help='specify discriminator architecture. The basic model is a 70x70 PatchGAN. dualbranch adds a batch-distribution head for GSGStain.')
